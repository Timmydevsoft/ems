...
const AdminSideBar = () => {
  ...
  return (
    <div className={`absolute ${auth.menu ? 'left-0':'-left-72'}  bg-gray-800 text-white lg:fixed h-screen lg:left-0 top-0 bottom-0 space-y-2 w-64 z-50 transition-all duration-1000 ease-in-out`}>
